...
class Manager():
    ...
    @classmethod
    def get_nodes(cls, input_count:int, output_count:int) -> tuple[list[int], list[int]] :
    ...
    def set_node_relations(self, other1:"IC", other2:"IC", node_index_output:int, node_index_input:int):
    ...
    def create_ic(self, ic:str): # Its been given string for now, idk how we gonna implement the gui
        pass
